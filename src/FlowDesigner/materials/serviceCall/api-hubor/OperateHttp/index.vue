...
import { type RequestObjType } from '../types';
  ...
  <div class="http-from">
    <div class="http-url">
      <AInputGroup compact style="display: flex;">
        <ASelect v-model:value="RequestObj.method" :options="Request_Method" />
        <AInput v-model:value="RequestObj.url" class="" @change="onUrlChange" />
      </AInputGroup>
    </div>
