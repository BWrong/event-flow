<template>
  <div>
    <AFormItem label="提示类型">
      <ASelect :style="{ width: '300px' }" v-model:value="formState.noticeType" :options="option" />
    </AFormItem>
    <AFormItem label="提示显示时长(秒)">
      <AInputNumber :style="{ width: '200px' }" v-model:value="formState.duration" />
    </AFormItem>
