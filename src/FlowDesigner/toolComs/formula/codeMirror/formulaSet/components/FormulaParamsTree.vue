...
import { findFlowParentIds, flatFlowTreeDataClosure } from '../../../../../utils/flowTree';
...
<template>
  <div class="formula-params">
    <div class="search-header">
      <Input placeholder="搜索变量" allow-clear :bordered="false" v-model:value="searchValue">
      <template #prefix>
    ...
    <Tree v-if="filteredFields.length > 0" class="params-list"
      :field-names="{ label: 'name', children: 'children', key: 'key' }" :tree-data="filteredFields"
      :expanded-keys="expandedKeys" :auto-expand-parent="autoExpandParent" @expand="onExpand"
      @select="handleSelectChange">
      <template #title="{ name, fieldType, sonModelName, isMultiple }">
        <!-- 字段渲染-->
        <div :title="name" class="field-item">
