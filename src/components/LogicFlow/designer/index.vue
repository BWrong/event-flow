      ...
      <div class="left-toolbar">
        <a-space>
          <a-tooltip title="变量设置" placement="bottom">
            <FunctionOutlined @click="showToolPanel = true" style="position: relative;top:1px" />
          </a-tooltip>
        </a-space>
...
import { AimOutlined, CheckCircleOutlined, FullscreenExitOutlined, FullscreenOutlined, FunctionOutlined, LeftCircleOutlined, MinusCircleOutlined, PlusCircleOutlined, RightCircleOutlined, UpOutlined } from '@ant-design/icons-vue';
import { useFullscreen } from '@vueuse/core';
import { Badge as ABadge, Divider as ADivider, Space as ASpace, Tooltip as ATooltip } from 'ant-design-vue';
import { computed, onBeforeUnmount, provide, ref, watch } from 'vue';
import type { Flow, FlowMaterialMap, FlowVariables, ValidateInfo } from '../types';
...
import { CreateVariables } from './resource/components/store';
...
watch(() => props.variables, (variables) => {
  designerStore.setVariables(variables)
}, {
  immediate: true
})
