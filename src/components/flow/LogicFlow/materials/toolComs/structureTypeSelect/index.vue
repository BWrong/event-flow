...
import { buildTree } from '../../../common/flowTree'
import ApiHubSelect from '../apiHubSelect/index.vue'
...
<template>
  <div class="type-dropdown-select-wrapper">
    ...
    <!-- apihub的选择:这里采用弹框,这里不回显选择中了 -->
    <ApiHubSelect
      v-model:visible="apiHubVisible"
      :value="value"
