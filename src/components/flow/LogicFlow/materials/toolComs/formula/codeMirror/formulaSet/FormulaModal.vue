...
<template>
  <FullModal
    ...
    allow-full-screen
    @ok="handleOk"
    @update:visible="emits('update:visible', !visible)"
  ...
  >
    <div class="formula-editor">
      <div class="editor">
        <Flex
          ...
          style="background-color: #f3f8fb;height: 40px"
        >
          <QuickOperator
            @operatorSelect="onOperatorSelect"
          />
        </Flex>
        ...
        <FieldEditor
          ref="fieldEditorRef"
          height="170px"
          :editor-value="editorInfo.editorValue"
        ...
        <div :class="['params', !collapse && 'full-width']">
          <div class="title">
            ...
            <IconFont
              ...
              :type="collapse ? 'icon-menu-unfold3' : 'icon-menu-fold'"
    ...
    <template #footer-left>
      <span
        v-if="!validResult.flag"
        class="valid-result text-error"
      >
        {{ validResult.msg }}
      </span>
    </template>
