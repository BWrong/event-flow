...
<template>
  <div class="var-dropdown-select-wrapper">
    <ADropdown
      ...
      trigger="click"
      :overlayStyle="{ width: dropDownWidth + 'px' }"
      @openChange="handleOpenChange"
      overlayClassName="field-tree-select-dropdown-wrapper"
    >
      <!-- 这里隐藏select自带的下拉 -->
      <ASelect
        v-if="mode === 'select'"
        ...
        :open="false"
        style="width: 100%"
        :status="(status as SelectStatus)"
        :placeholder="placeholder"
        @mouseenter="selectHover = true"
...
import { CloseCircleOutlined, PlusOutlined, DownOutlined, UpOutlined, CaretDownOutlined } from '@ant-design/icons-vue'
